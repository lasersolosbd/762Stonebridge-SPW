  ...
  return (
    <footer className="bg-[#0f172a] text-stone-400">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        {/* Quick Links */}
        <div>
          <h4 className="text-white text-sm font-semibold tracking-widest uppercase mb-5" style={{ fontFamily: "var(--font-display)" }}>
            Navigate
          </h4>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3">
            ...
            <li><Link href="/fair-housing" className="text-sm text-stone-400 hover:text-[#c9a84c]">Fair Housing Statement</Link></li>
          </ul>
        </div>
      </div>
